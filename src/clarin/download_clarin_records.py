...
def download_clarin_records():
    ...
    clarin_centers = [{
        ...
        'path':
        os.path.join(get_project_root(), "data", "clarin", "bas")
    }, {
        'url':
        'https://clarin.bbaw.de:8088/oaiprovider',
        'path':
        os.path.join(get_project_root(), "data", "clarin", "bbaw")
    }, {
        'url':
        'https://www.fdr.uni-hamburg.de/oai2d',
        'path':
        os.path.join(get_project_root(), "data", "clarin", "hzsk")
    }, {
        'url':
        'https://repos.ids-mannheim.de/oaiprovider',
        'path':
        os.path.join(get_project_root(), "data", "clarin", "ids")
    }, 
    #{
    #     'url':
    #     'http://clarin04.ims.uni-stuttgart.de/oaiprovider',
    #     'path':
    #     os.path.join(get_project_root(), "data", "clarin", "ims")
    # }, 
    {
        'url':
        'https://repo.data.saw-leipzig.de/oai-pmh',
        'path':
        os.path.join(get_project_root(), "data", "clarin", "saw")
    }, {
        'url':
        'https://fedora.clarin-d.uni-saarland.de/oaiprovider',
        'path':
        os.path.join(get_project_root(), "data", "clarin", "uds")
    }, 
    #{
    #     'url':
    #     'https://oai.cedifor.de?',
    #     'path':
    #     os.path.join(get_project_root(), "data", "clarin", "cedifor")
    # }, 
    {
        'url':
        ...
        'path':
        os.path.join(get_project_root(), "data", "clarin", "lac")
    }, {
        'url':
